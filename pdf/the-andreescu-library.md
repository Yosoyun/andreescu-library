...
| **2006** | Founds **AwesomeMath**, the free journal **Mathematical Reflections**, and the Metroplex Math Circle; joins UT Dallas. |
...
|---|---|---|---|
| 101 Problems in Algebra — *From the Training of the USA IMO Team* | 2001 | with Zuming Feng | Algebra · Olympiad |
| 102 Combinatorial Problems — *From the Training of the USA IMO Team* | 2003 | with Zuming Feng | Combinatorics · Olympiad |
| 103 Trigonometry Problems — *From the Training of the USA IMO Team* | 2005 | with Zuming Feng | Trigonometry · Olympiad |
| 104 Number Theory Problems — *From the Training of the USA IMO Team* | 2007 | with Dorin Andrica, Zuming Feng | Number Theory · Olympiad |
...
| A Path to Combinatorics for Undergraduates — *Counting Strategies* | 2004 | with Zuming Feng | Combinatorics · Undergraduate |
...
| Number Theory — *Structures, Examples, and Problems* | 2009 | with Dorin Andrica | Number Theory · Intermediate |
| An Introduction to Diophantine Equations — *A Problem-Based Approach* | 2010 | with Dorin Andrica, Ion Cucurezeanu | Number Theory · Olympiad |
| Essential Linear Algebra with Applications — *A Problem-Solving Approach* | 2014 | — | Linear Algebra · Undergraduate |
...
| 105 Algebra Problems — *from the AwesomeMath Summer Program* | 2011 | — | Algebra · Olympiad |
| Straight from the Book | 2012 | with Gabriel Dospinescu | Problem Solving, Advanced · Advanced |
| 106 Geometry Problems — *from the AwesomeMath Summer Program* | 2013 | with Michal Rolínek, Josef Tkadlec | Geometry · Olympiad |
| 107 Geometry Problems — *from the AwesomeMath Year-Round Program* | 2013 | with Michal Rolínek, Josef Tkadlec | Geometry · Olympiad |
| 110 Geometry Problems for the International Mathematical Olympiad | 2014 | with Cosmin Pohoață | Geometry · Olympiad |
| 108 Algebra Problems — *from the AwesomeMath Year-Round Program* | 2016 | — | Algebra · Olympiad |
| Lemmas in Olympiad Geometry | 2016 | with Sam Korsky, Cosmin Pohoață | Geometry · Olympiad |
| Number Theory — *Concepts and Problems* | 2017 | with Gabriel Dospinescu, Oleg Mushkarov | Number Theory · Advanced |
| Mathematical Induction — *A Powerful and Elegant Method of Proof* | 2017 | with Vlad Crișan | Proof Techniques · Intermediate |
...
| 117 Polynomial Problems — *from the AwesomeMath Summer Program* | 2019 | with Navid Safaei, Alessandro Ventullo | Polynomials, Algebra · Olympiad |
...
| Algebraic Inequalities — *New Vistas* | 2019 | — | Inequalities, Algebra · Olympiad |
| Topics in Functional Equations — *Third Edition* | 2020 | with Iurie Boreico, Oleg Mushkarov, Nikolai Nikolov | Functional Equations · Olympiad |
| A Romanian Problem Book | 2020 | with Marian Tetiva | Problem Solving · Olympiad |
| Awesome Math — *Teaching Mathematics with Problem Based Learning* | 2020 | with Kathy Cordeiro, Alina Andreescu | Pedagogy · Educators |

### MAA Competition Archives

| Title | Year | Collaborators | Topic · Level |
|---|---|---|---|
| Mathematical Olympiads: Problems and Solutions from Around the World — *Annual series, 1995–2001* | 1997 | edited with Zuming Feng, Kiran Kedlaya & others | Competition Archive · Olympiad |
| USA and International Mathematical Olympiads — *Annual series, 2000–2004* | 2001 | edited with Zuming Feng | Competition Archive · Olympiad |

### Mathematical Reflections — Collected Volumes

The free journal he founded is also published as two-year hardcover collections (XYZ Press), 2006–2023:
*The First Two Years · The Next Two Years · Two More Years · Two Special Years (2014–15) · Two Wonderful Years (2016–17) · Two Lockdown Years (2020–21) · Two Meaningful Years (2022–23).*
**The journal itself is free to read online — see below.**
...
**Zuming Feng** (7) · **Dorin Andrica** (5) · **Oleg Mushkarov** (4) · **Marian Tetiva** (4) · **Gabriel Dospinescu** (3) · **Răzvan Gelca** (2) · **Cosmin Pohoață** (2) · **Cristinel Mortici** (2) · **Navid Safaei** (2) · **Alessandro Ventullo** (2) · **Michal Rolínek** (2) · **Josef Tkadlec** (2) · Bogdan Enescu · Ion Cucurezeanu · Luchezar Stoyanov · Sam Korsky · Vlad Crișan · Iurie Boreico · Nikolai Nikolov · Kathy Cordeiro · Alina Andreescu · Kiran Kedlaya.
...
- **Mathematical Reflections — the free journal he founded.** Every current and archived issue is free to read.
  → <https://www.awesomemath.org/mathematical-reflections/>
- **AMC · AIME · USAMO past problems.** Decades of competition problems and solutions, free.
  → <https://artofproblemsolving.com/wiki/index.php/AMC_Problems_and_Solutions>
- **Internet Archive — borrow legally.** Many titles can be borrowed for free (controlled digital lending), one reader at a time.
  → <https://archive.org/search?query=Titu+Andreescu>
- **Google Books — generous free previews**, often whole chapters, of most titles.
  → <https://www.google.com/search?tbm=bks&q=Titu+Andreescu>
- **Art of Problem Solving — free community & wiki**, where these books are discussed problem-by-problem.
  → <https://artofproblemsolving.com/community>
- **Your library.** School, college and city libraries can order or inter-loan these titles; many Indian university libraries already hold the Springer/Birkhäuser editions.
  → <https://www.worldcat.org/search?q=au%3ATitu+Andreescu>
...
**No files are hosted or distributed here.** Every book listed is copyrighted by its authors and publishers. This guide contains **no** PDFs and links to **no** pirated copies — only to legitimate retailers, legal library lending, free previews, publisher pages, and genuinely free material. Please support the authors by buying or borrowing through legitimate channels.

**On accuracy.** Bibliographic details were compiled from public sources; several titles have multiple editions, and some entries list the lead author only. Corrections are welcome via the project's GitHub repository.
